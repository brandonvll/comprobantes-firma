    ...
    <div className="w-full rounded-2xl border border-emerald-500/30 bg-slate-900/80 p-6 backdrop-blur-md shadow-2xl space-y-6">
      ...
      <div className="space-y-4 border-b border-slate-800 pb-4">
        <div className="flex flex-wrap items-center justify-between gap-4">
          ...
          {/* Action Controls - inline on desktop */}
          <div className="flex items-center gap-3">
            ...
            {/* Download PNG Button - hidden on mobile, visible on md+ */}
            <button
              onClick={handleDownload}
              className="hidden md:flex px-5 py-2.5 rounded-xl bg-gradient-to-r from-emerald-500 to-teal-500 hover:from-emerald-400 hover:to-teal-400 text-white text-xs font-bold shadow-lg shadow-emerald-500/20 items-center gap-2 transition-all transform hover:scale-[1.02]"
            >
        ...
        {/* Download PNG Button - full width on mobile only */}
        <button
          onClick={handleDownload}
          className="md:hidden w-full py-3 rounded-xl bg-gradient-to-r from-emerald-500 to-teal-500 hover:from-emerald-400 hover:to-teal-400 text-white text-sm font-bold shadow-lg shadow-emerald-500/20 flex items-center justify-center gap-2 transition-all active:scale-[0.98]"
        >
